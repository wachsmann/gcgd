...
class ExpenseView extends React.Component {
  ...
  handlePay = (event,id)=>{
    event.stopPropagation();
		...
		this.props.dispatch(expenseActions.pay({id}));
                          ...
                          {list && list.map((result, i) =>
                            <tr key={result.id}>
                              ...
                              <ButtonToolbar>
                                {
                                  result.status != "Pago" ?
                                  <Button id={result.id} onClick={event => this.handlePay(event, result.id)} variant="success" data-toggle="tooltip" title="Pagar">
                                ...
                                <Button variant="warning" id={result.id} onClick={event => this.handleEdit(event, result.id)} data-toggle="tooltip" title="Editar">
